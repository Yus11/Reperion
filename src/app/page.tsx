...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      ...
      <div className="before:bg-gradient-radial before:to-transparent after:bg-gradient-conic after:from-sky-200 after:via-blue-200 before:dark:from-transparent before:dark:to-blue-700 after:dark:from-sky-900 relative z-[-1] flex place-items-center before:absolute before:h-[300px] before:w-[480px] before:-translate-x-1/2 before:rounded-full before:from-white before:blur-2xl before:content-[''] after:absolute after:-z-20 after:h-[180px] after:w-[240px] after:translate-x-1/3 after:blur-2xl after:content-[''] before:dark:bg-gradient-to-br before:dark:opacity-10 after:dark:via-[#0141ff] after:dark:opacity-40 before:lg:h-[360px]">
        <Image
      ...
      <div className="mb-32 grid text-center lg:mb-0 lg:w-full lg:max-w-5xl lg:grid-cols-4 lg:text-left">
        ...
        >
          ...
          <p className={`text-sm m-0 max-w-[30ch] opacity-50`}>Explore the Next.js 13 playground.</p>
        </a>
