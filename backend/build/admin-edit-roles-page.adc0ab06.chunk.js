(self.webpackChunkcms=self.webpackChunkcms||[]).push([[2544],{98374:(U,L,o)=>{"use strict";o.d(L,{F:()=>O});var e=o(27279),h=o(60548),P=o(61020),v=o(40464);const O=(T={},R={})=>{const{id:E="",...S}=T,{get:V}=(0,h.kY)(),{locale:a}=(0,P.Z)(),Z=(0,h.Xe)(a,{sensitivity:"base"}),{data:m,error:M,isError:F,isLoading:g,refetch:b}=(0,v.useQuery)(["roles",E,S],async()=>{const{data:Q}=await V(`/admin/roles/${E??""}`,{params:S});return Q},R);return{roles:e.useMemo(()=>{let Q=[];return m&&(Array.isArray(m.data)?Q=m.data:Q=[m.data]),[...Q].sort((oe,ee)=>Z.compare(oe.name,ee.name))},[m,Z]),error:M,isError:F,isLoading:g,refetch:b}}},24233:(U,L,o)=>{"use strict";o.d(L,{V:()=>P});var e=o(60548),h=o(40464);const P=(v={id:null},O={})=>{const{id:T,...R}=v,{get:E}=(0,e.kY)(),{data:S,error:V,isError:a,isLoading:Z,refetch:m}=(0,h.useQuery)(["roles",T,"permissions",R],async()=>{const{data:{data:M}}=await E(`/admin/roles/${T}/permissions`,{params:R});return M},O);return{permissions:S,error:V,isError:a,isLoading:Z,refetch:m}}},25545:(U,L,o)=>{"use strict";o.r(L),o.d(L,{CreatePage:()=>me,default:()=>Ae});var e=o(27279),h=o(73354),P=o(27875),v=o(10701),O=o(48102),T=o(74758),R=o(93415),E=o(32370),S=o(23298),V=o(74577),a=o(12881),Z=o(39708),m=o(60548),M=o(76827),F=o(84260),g=o(71563),b=o(10124),z=o.n(b),Q=o(61020),oe=o(49402),ee=o(51447),C=o(19003),de=o(36364),J=o(30909),te=o(90065),Y=o(24233),ue=o(47853);const Le=ue.Ry().shape({name:ue.Z_().required(m.I0.required),description:ue.Z_().required(m.I0.required)}),ce=C.ZP.div`
